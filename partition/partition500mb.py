...
spark = SparkSession.builder \
    .appName("Partitioned500MB") \
    .enableHiveSupport() \
    .getOrCreate()

# Read raw Parquet data
df = spark.read.parquet("hdfs://master:8020/data/500mb/")
...
df.write.partitionBy("RatecodeID", "VendorID", "payment_type") \
    .option("path", "hdfs://master:8020/data/nyc_taxi_partitioned_500mb") \
    .mode("overwrite") \
    .saveAsTable("taxi_data_partitioned_500mb")

...
spark = SparkSession.builder \
    .appName("Partitioned5MB") \
    .enableHiveSupport() \
    .getOrCreate()

# Read raw Parquet data
df = spark.read.parquet("hdfs://master:8020/data/5mb/")
...
df.write.partitionBy("RatecodeID", "VendorID", "payment_type") \
    .option("path", "hdfs://master:8020/data/nyc_taxi_partitioned_5mb") \
    .mode("overwrite") \
    .saveAsTable("taxi_data_partitioned_5mb")

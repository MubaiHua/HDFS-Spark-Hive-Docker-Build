...
spark = SparkSession.builder \
    .appName("PartitionedHiveTable") \
    .enableHiveSupport() \
    .getOrCreate()

# Read raw Parquet data
df = spark.read.parquet("hdfs://master:8020/data/nyc_test/")
...
df.write.partitionBy("RatecodeID", "VendorID", "payment_type") \
    .option("path", "hdfs://master:8020/data/nyc_taxi_partitioned") \
    .mode("overwrite") \
    .saveAsTable("taxi_data_partitioned")
